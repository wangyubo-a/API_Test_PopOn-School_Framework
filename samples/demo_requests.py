...
list8 = [{'测试用例编号': 'api_case_01', '测试用例名称': '获取token接口测试', '用例执行': '是', '用例步骤': 'step_01', '接口名称': 'login2b', '请求方式': 'post', '请求头部信息': '', '请求地址': '/wordoor_uaas_api/v1/busins/login2b', '请求参数(get)': '', '请求参数(post)': '{"acc": "a1@qq.com", "pwd": "123456.."}', '取值方式': 'month_time', '取值代码': '0,', '取值变量': 'today_1', '断言类型': 'json_key', '期望结果': 'result'}]

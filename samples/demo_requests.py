...
list7 = [{'测试用例编号': 'api_case_13', '测试用例名称': '移除教材小组', '用例执行': '是', '用例步骤': 'step_01', '接口名称': 'login2b', '请求方式': 'post', '请求头部信息': '', '请求地址': '/wordoor_uaas_api/v1/busins/login2b', '请求参数(get)': '', '请求参数(post)': '{"acc": "a1@qq.com", "pwd": "123456.."}', '取值方式': 'jsonpath取值,响应头取值', '取值代码': '$.result.userExchange.config.id,A-Token-Header', '取值变量': 'userid,token', '断言类型': 'header_key', '期望结果': 'A-Token-Header'}, {'测试用例编号': 'api_case_13', '测试用例名称': '移除教材小组', '用例执行': '是', '用例步骤': 'step_02', '接口名称': '机构列表接口', '请求方式': 'post', '请求头部信息': '{"A-Token-Header": ${token}}', '请求地址': '/wordoor_uaas_api/v1/busins/userOrgList', '请求参数(get)': '', '请求参数(post)': '{"identity": "Tutor", "targetUserId": ${userid}}', '取值方式': 'jsonpath取值', '取值代码': '$.result[0].id', '取值变量': 'departmentId', '断言类型': 'response_code', '期望结果': 200.0}, {'测试用例编号': 'api_case_13', '测试用例名称': '移除教材小组', '用例执行': '是', '用例步骤': 'step_03', '接口名称': '移除教材小组', '请求方式': 'post', '请求头部信息': '{"A-Token-Header": ${token}}', '请求地址': '/wordoor_uaas_api/v1/busins/book/removeGroup', '请求参数(get)': '', '请求参数(post)': '{"id":"4","userId":${userid}}', '取值方式': '', '取值代码': '', '取值变量': '', '断言类型': 'code_check', '期望结果': 200.0}]
rquestsUtils = RequestsUtils()
